...
<body>
  <?php
   ...
   {
	   $sqlQuery = "SELECT firstName,lastName,age,address,district,state,email,mobileNo,accountNo,Password FROM user_details WHERE accountNo=".$_SESSION['AccountNo'];
   ...
   if (isset($_POST['submit1']))
	 {
		 $sql="UPDATE user_details SET firstName='$fName2', lastName='$lName2', gender='$gender2',age='$age2',address='$address2',district='$district2',state='$state2',email='$email2', mobileNo='$mobileNo2', Password='$pass2' WHERE accountNo=".$_SESSION['AccountNo'];
		...
		$_SESSION['Username1']=$fName2;
		$_SESSION['Username2']=$lName2;
		
		$updation="Your information updated";
	 }
   }
  ...
  <div class="body2"></div>
		...
		<div class="Myprofile"style="height: 120%;">
				<ul>
		 ...
		 <span id="span1" style="margin-left:43%"><u>Edit Profile</u></span><br><br>
		 <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
				...
				<span class="error"> <?php echo $updation;?></span><br><br>
			</form>
		</div>
